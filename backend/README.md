...
## Project Structure
    ...
    ├── demo_app_with_tim_39193  # Django project configurations
...
1. Clone this repo and `cd demo_app_with_tim_39193`
...
2. Clone this repo and `cd demo_app_with_tim_39193`
